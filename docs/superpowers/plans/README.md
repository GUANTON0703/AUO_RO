...
| # | 計畫 | 產出 | 依賴 | 檔名 |
|---|---|---|---|---|
| 1 | 地基 ✅ | 能註冊/登入/建角色的伺服器（已完成，60 測試綠 + codex LGTM）| — | `2026-09-06-01-foundation.md` |
| 2 | 資料管線 ✅ | v1 資料集（42 怪/8 MVP/26 卡/33 裝備/32 技能）+ schema + 載入驗證（97 測試綠 + codex LGTM）| 1 | `2026-09-06-02-content-pipeline.md` |
